...
<queries>
  ...
  CDR_Job_Inten_new<-technology_df %>%left_join(CDR_Job_Inten,by=c("GCAM_techn"="CDR"), relationship = "many-to-many")
  ...
  if (create_plots) {
    ...
    # Visualize jobs by technology by year
