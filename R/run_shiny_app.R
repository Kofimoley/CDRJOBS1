...
run_shiny_app <- function(output_path) {
  ...
  job_by_tech_year_data <- read.csv(file.path(output_path, "Job_by_tech_year.csv"))
  job_cum_tech_data <- read.csv(file.path(output_path, "Job_cum_tech.csv"))

  # Create a list of datasets
  results <- list(
    Job_cum_total = job_cum_total_data,
    Job_total_year = job_total_year_data,
    Job_by_tech_year_data = Job_by_tech_year_data,
